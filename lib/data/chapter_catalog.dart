  ...
  begin: 80,
    ...
    exercises: [
      Exercise(
        ...
        prompt: '说明 Controller、Tween、Curve 分别解决什么问题，并指出谁负责总时长。',
        acceptanceCriteria: ['准确描述三者职责', '指出总时长由 Controller 决定'],
      ),
      Exercise(
        id: '1-2',
        title: '映射温度值',
      ...
      Exercise(
        ...
        prompt: '为按钮变色、无限旋转、页面共享图片三个需求分别选择动画方案，并解释原因。',
        acceptanceCriteria: ['每个需求都有具体 API', '解释是否需要 Controller'],
      ),
      Exercise(
        id: '1-4',
        title: '制作曲线比较器',
  ...
  child: const Text('点我'),
    ...
    exercises: [
      Exercise(
        ...
        title: '隐式动画判断',
        difficulty: ExerciseDifficulty.concept,
        prompt: '解释为什么简单的卡片选中态不必创建 AnimationController。',
        acceptanceCriteria: ['描述目标状态驱动方式', '提到更少的生命周期管理'],
      ),
      Exercise(
        id: '2-2',
        title: '收藏按钮反馈',
      ...
      Exercise(
        ...
        difficulty: ExerciseDifficulty.challenge,
        prompt:
            '组合 AnimatedContainer、AnimatedAlign 和 AnimatedDefaultTextStyle 完成资料卡展开效果。',
  ...
  child: Text(
    ...
    exercises: [
      Exercise(
        ...
        title: 'Key 为什么重要',
        difficulty: ExerciseDifficulty.concept,
        prompt: '说明数字变化时为什么要给 Text 添加 ValueKey(count)。',
        acceptanceCriteria: ['提到 Widget 身份', '解释同类型无 Key 的更新行为'],
      ),
      Exercise(
        id: '3-2',
        title: '加载按钮',
  ...
  child: const Icon(Icons.favorite),
    ...
    exercises: [
      Exercise(
        ...
        title: '何时使用 Builder',
        difficulty: ExerciseDifficulty.concept,
        prompt: '对比 TweenAnimationBuilder 与 AnimationController 的适用条件。',
        acceptanceCriteria: ['说明是否需要播放控制', '说明生命周期差异'],
      ),
      Exercise(
        id: '4-2',
        title: '分数递增',
      ...
      Exercise(
        ...
        difficulty: ExerciseDifficulty.application,
        prompt:
            '用一个 TweenAnimationBuilder 同时驱动 CircularProgressIndicator 和百分比文本。',
  ...
  super.dispose();
    ...
    exercises: [
      Exercise(
        ...
        title: 'Ticker 与释放',
        difficulty: ExerciseDifficulty.concept,
        prompt: '解释 vsync 的作用，以及忘记 dispose Controller 的后果。',
        acceptanceCriteria: ['提到不可见时减少帧更新', '提到资源泄漏或断言错误'],
      ),
      Exercise(
        id: '5-2',
        title: '旋转控制器',
  ...
  child: SlideTransition(
    ...
    exercises: [
      Exercise(
        ...
        title: 'Offset 的单位',
        difficulty: ExerciseDifficulty.concept,
        prompt: '说明 SlideTransition 中 Offset(0, 1) 的真实含义。',
        acceptanceCriteria: ['指出相对 child 尺寸', '与像素位移作对比'],
      ),
      Exercise(
        id: '6-2',
        title: '底部入场',
  ...
  transitionsBuilder: (_, animation, __, child) {
    ...
    exercises: [
      Exercise(
        ...
        title: '默认还是自定义',
        difficulty: ExerciseDifficulty.concept,
        prompt: '列出适合保留 MaterialPageRoute 默认转场的情况和需要自定义转场的情况。',
        acceptanceCriteria: ['考虑平台一致性', '给出至少一个自定义理由'],
      ),
      Exercise(
        id: '7-2',
        title: '淡入页面',
  ...
  CurvedAnimation(
    ...
    exercises: [
      Exercise(
        ...
        title: '计算实际时间',
        difficulty: ExerciseDifficulty.concept,
        prompt: '总时长 1200ms 时，计算 Interval(0.25, 0.75) 的开始、结束和持续时间。',
        acceptanceCriteria: ['开始为 300ms', '结束为 900ms', '持续 600ms'],
      ),
      Exercise(
        id: '8-2',
        title: '三段入场',
  ...
  // ...
    ...
    exercises: [
      Exercise(
        ...
        title: '定位重建成本',
        difficulty: ExerciseDifficulty.concept,
        prompt: '说明 AnimatedBuilder.child 为什么能降低重建成本，以及它不能解决什么问题。',
        acceptanceCriteria: ['指出静态子树复用', '区分重建与重绘'],
      ),
      Exercise(
        id: '9-2',
        title: '支持减少动态效果',
      ...
      Exercise(
        ...
        title: '动画代码审查',
        difficulty: ExerciseDifficulty.challenge,
        prompt: '审查一个包含多个 Controller 和大型列表动画的页面，提出生命周期、性能、语义和测试改进。',
        acceptanceCriteria: ['覆盖四个维度', '建议可以直接执行', '区分必要优化与过早优化'],
      ),
    ],
  ),
];
